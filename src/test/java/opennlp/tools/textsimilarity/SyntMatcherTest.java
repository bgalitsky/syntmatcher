...
public class SyntMatcherTest
{
	...
	public void matchTest()
	{
		...
		assertEquals(matchResult.toString(), "[[ [NNP-pulitzer JJ-prize-winning NN-reporter ],  [NNP-* ],  [JJ-* NN-immigrant ]], [ [JJ-* NN-immigrant ]]]");
		System.out.println(parseTreeChunk.listToString(matchResult));
		assertEquals(parseTreeChunk.listToString(matchResult), " np [ [NNP-pulitzer JJ-prize-winning NN-reporter ],  [NNP-* ],  [JJ-* NN-immigrant ]] vp [ [JJ-* NN-immigrant ]]");
		...
		System.out.println(matchResult);
		assertEquals(matchResult.toString(), "[[ [DT-the NN-* VBG-flying NN-car ]], []]");
		System.out.println(parseTreeChunk.listToString(matchResult));
		assertEquals(parseTreeChunk.listToString(matchResult), " np [ [DT-the NN-* VBG-flying NN-car ]]");
	...
	{
		syntMatcher = SyntMatcher.getInstance();
		List<List<ParseTreeChunk>> matchResult = syntMatcher.matchOrigSentencesCache(
		"I am curious how to use the digital zoom of this camera for filming insects",
		"How can I get short focus zoom lens for digital camera"
		);

		System.out.println(matchResult);
		assertEquals(matchResult.toString(), "[[ [NN-zoom ],  [JJ-digital NN-* ],  [NN-camera ]], [ [JJ-digital NN-* ],  [NN-zoom NN-camera ],  [NN-* IN-for ]]]");
		System.out.println(parseTreeChunk.listToString(matchResult));
		assertEquals(parseTreeChunk.listToString(matchResult), " np [ [NN-zoom ],  [JJ-digital NN-* ],  [NN-camera ]] vp [ [JJ-digital NN-* ],  [NN-zoom NN-camera ],  [NN-* IN-for ]]");
		...
		System.out.println(matchResult);
		assertEquals(matchResult.toString(), "[[ [NN-focus NN-* ],  [JJ-digital NN-camera ]], [ [VB-get NN-focus NN-* NN-lens IN-for JJ-digital NN-camera ]]]");
		System.out.println(parseTreeChunk.listToString(matchResult));
		assertEquals(parseTreeChunk.listToString(matchResult), " np [ [NN-focus NN-* ],  [JJ-digital NN-camera ]] vp [ [VB-get NN-focus NN-* NN-lens IN-for JJ-digital NN-camera ]]");
