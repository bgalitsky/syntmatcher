...
public class GeneratedSentenceProcessor
{
	public static String acceptableMinedSentence(String sent)
	{
		...
		if (sentTry.indexOf("click here") > -1 || sentTry.indexOf(" wikip") > -1 || sentTry.indexOf("copyright") > -1
			...
			|| sentTry.indexOf("official site") > 0 || sentTry.indexOf("this video") > 0
			|| sentTry.indexOf("this book") > 0 || sentTry.indexOf("this product") > 0
			|| sentTry.indexOf("paperback") < 0 || sentTry.indexOf("hardcover") < 0 || sentTry.indexOf("audio cd") > 0
			|| sentTry.indexOf("related searches") > 0 || sentTry.indexOf("permission is granted") > 0
			|| sentTry.indexOf("[edit") > 0 || sentTry.indexOf("free license") > 0
			|| sentTry.indexOf("permission is granted") > 0 || sentTry.indexOf("under the terms") > 0
		...
		sent = sent.replace('[', ' ').replace(']', ' ').replace("_should_find_orig_", "").replace(".   .", ". ")
			...
			.replace("  ", " ").replace("(more.)", "").replace("more.", "").replace("<more>", "").replace("[more]", "")
