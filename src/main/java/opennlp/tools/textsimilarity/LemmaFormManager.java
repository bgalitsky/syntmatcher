...
public class LemmaFormManager
{
	...
	public String matchLemmas(PorterStemmer ps, String lemma1, String lemma2, String POS)
	{
		if (POS == null)
		{
			return null;
		...
		if (lemma1.endsWith("_xyz") || lemma2.endsWith("_xyz"))
		{
			...
			{ // trying to check if nouns and different plural/single form
